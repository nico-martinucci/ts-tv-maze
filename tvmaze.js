...
var PLACEHOLDER_IMAGE_AT_THE_TOP_OF_THE_FILE = "https://innovating.capital/wp-content/uploads/2021/05/vertical-placeholder-image.jpg";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    showData = response.data.map(function (result) {
                        var _a;
                        var s = result.show;
                        return {
                            id: s.id,
                            name: s.name,
                            summary: s.summary,
                            image: ((_a = s.image) === null || _a === void 0 ? void 0 : _a.medium) || PLACEHOLDER_IMAGE_AT_THE_TOP_OF_THE_FILE
                        };
                    });
...
function getEpisodesOfShow(id) {
    return __awaiter(this, void 0, void 0, function () {
        var response, episodesData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get("".concat(BASE_URL, "/shows/").concat(id, "/episodes"))];
                case 1:
                    response = _a.sent();
                    episodesData = response.data.map(function (e) { return ({
                        id: e.id,
                        name: e.name,
                        season: e.season,
                        number: e.number
                    }); });
                    return [2 /*return*/, episodesData];
            }
        });
    });
}
...
function populateEpisodes(episodes) {
    ...
    for (var _i = 0, episodes_1 = episodes; _i < episodes_1.length; _i++) {
        var e = episodes_1[_i];
        var $episode = $("\n      <li>\n        ".concat(e.name, " (season ").concat(e.season, ", episode ").concat(e.number, ")\n      </li>\n    "));
        $episodesArea.append($episode);
    }
    $episodesArea.show();
}
/** Controller function to fetch episodes and append them to the DOM. */
function getAndShowEpisodes(event) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    event.preventDefault();
                    $button = $(event.target);
                    showId = $button.closest(".Show").data("show-id");
